...
if __name__ == "__main__":
    ...
    X_test_pca = pca.transform(X_teest_scaled)
    print("PCA done.")
    ...
    X_train_nn = Tensor(X_train_pca)
    X_test_nn = Tensor(X_test_pca)
    torch.save(X_train_nn, "/mnt/scratch/grunew14/data/X_train_nn_pca.pt")
    torch.save(X_test_nn, "/mnt/scratch/grunew14/data/X_test_nn_pca.pt")
