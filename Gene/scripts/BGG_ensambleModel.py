...
if __name__ == "__main__":
    ...
    with open(model_log, "a") as f:
        ...
        f.write(
            f"Bagging Regressor Ensemble Model: n_estimators={n_estimators}, lr={lr}, weight_decay={weight_decay}, epochs={epochs}\n"
        )
    ...
    torch.save(model, "/mnt/home/grunew14/Documents/ss-23-classes/cmse381/gene-project/trained_models/BGG_ensambleModel.pt")
    print("Model saved.")
